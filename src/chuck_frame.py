...
class AppLogic:
    ...
    def __init__(self, root: tk.Tk, gui: ChuckFrame, controller: controllerDrive.ControllerPoller, serial: serialDrive.SerialArduino):
...
def main(port, controllerID):
    ...
    print("[Chuck] Starting main loop")
