...
def get_arduino_port():
    ...
    # Identifiers for Arduino Mega 2560 and clones (common VID/PID combinations)
    ...
    for port in ports:
        ...
        # Method 1: Check by precise numeric Vendor/Product IDs (Bulletproof for Mac/Linux)
    ...
    print("Examples: COM3 (Windows), /dev/ttyACM0 (Linux), /dev/tty.usbmodem11101 (Mac)")
...
class DCFrame:
    ...
    def __init__(self, root: tk.Tk):
        ...
        self.root = root
        self.root.title("DC Probe Controller")
        ...
        # StringVars for live absolute position display (updated from firmware POS: messages)
        ...
        self.entry_slow_speed: tk.Entry
    ...
    def _main_window(self):
        ...
        tk.Label(self.root, text="--- Absolute Position (from boot zero) ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1

        tk.Label(self.root, text="X Position:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="Y Position:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="Z Position:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        # INPUT FIELDS
        tk.Label(self.root, text="--- Serial Port ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
        
        tk.Label(self.root, text="Serial Port:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="--- Step Sizes ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
        
        tk.Label(self.root, text="X Step Size:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_x_step = tk.Entry(self.root); self.entry_x_step.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_x_step.insert(0, "1"); row_counter += 1
        
        tk.Label(self.root, text="Y Step Size:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_y_step = tk.Entry(self.root); self.entry_y_step.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_y_step.insert(0, "1"); row_counter += 1
        
        tk.Label(self.root, text="Z Step Size:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_z_step = tk.Entry(self.root); self.entry_z_step.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_z_step.insert(0, "1"); row_counter += 1

        # CHANGED: Section header and labels renamed for relative stepping clarity
        tk.Label(self.root, text="--- Relative Step Counts ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
        
        # CHANGED: "X Distance:" → "X Steps:", default "0.0" → "0"
        tk.Label(self.root, text="X Steps:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="Y Steps:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="Z Steps:").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="--- Velocity and Brake Control ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
        
        tk.Label(self.root, text="Full Speed (PWM):").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_full_speed = tk.Entry(self.root); self.entry_full_speed.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_full_speed.insert(0, "120"); row_counter += 1
        
        tk.Label(self.root, text="Brake Speed (PWM):").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_slow_speed = tk.Entry(self.root); self.entry_slow_speed.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_slow_speed.insert(0, "0"); row_counter += 1
        
        tk.Label(self.root, text="Brake Distance (Counts):").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        ...
        tk.Label(self.root, text="Manual mode Max Speed (PWM):").grid(row=row_counter, column=0, padx=5, pady=2, sticky='w')
        self.entry_man_full_speed = tk.Entry(self.root); self.entry_man_full_speed.grid(row=row_counter, column=1, padx=5, pady=2); self.entry_man_full_speed.insert(0, "120"); row_counter += 1

        # BUTTONS HEADER
        tk.Label(self.root, text="--- Motor Commands ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
        ...
        bg='darkblue', fg='black', font=('Arial', 10, 'bold'))
        ...
        tk.Label(self.root, text="--- Additional Controls ---", font=('Arial', 10, 'bold')).grid(row=row_counter, column=0, columnspan=2, pady=5); row_counter += 1
    ...
    def get_gui_params(self, manual_flag: bool, auton_flag: bool):
        return {
            ...
            "slow_speed": self.entry_slow_speed.get(),           
...
# ---------------- APP LOGIC CLASS ------------------
class AppLogic:
    def __init__(self, root: tk.Tk, gui: DCFrame, controller: controllerDrive.ControllerPoller, serial: serialDrive.SerialArduino):
    ...
    # Worst case uncomment this to bring back restriction
