...
class StepperFrame:
    ...
    def _main_window(self):
        ...
        tk.Label(self.root, text="Powers of 2; 8 or 16 recommended for AUTON", bg=bg_main, fg=fg_accent).grid(row=row_counter, column=0, columnspan=2, pady=0); row_counter+=1
