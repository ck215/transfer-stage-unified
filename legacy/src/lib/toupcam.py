...
TOUPCAM_GVCP_RETRY_MAX            = 16
TOUPCAM_GVCP_TIMEOUT_DEF          = 15       # GVCP Timeout
TOUPCAM_GVCP_TIMEOUT_MIN          = 5
TOUPCAM_GVCP_TIMEOUT_MAX          = 150
...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 59.30594.20260120"""
        cls.__initlib()
