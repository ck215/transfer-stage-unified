...
and the autouse fixture makes that structural: `devices.gamepad.pygame`
...
from devices.gamepad import Gamepad, GamepadHub, hub as module_hub
...
def platform_as(name):
    with patch("devices.gamepad.sys.platform", name):
        yield
