...
| 9 | Focus-area drag-select gave zero on-screen confirmation of what was captured (compounds the Linux "blind" issue, see open items) | `SelectionOverlay.mouseReleaseEvent` only `print()`ed | `a7a8eaa` | `views/pyside/view.py` |
